...
<p align="right"><a href="<?= base_url() ?>cuidado/" title="Ver quem somos" class="criarnovo" target="_blank">Visualizar Cuidados</a></p>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="<?= base_url() ?>admincuidado/editar/<?=$row->entry_id?>" class="acoes">Editar</a></td>
        </tr>
...
<form method="post" action="<?= base_url() ?>admincuidado/cadastrarimagem/" id="inserir-blog" enctype="multipart/form-data">
