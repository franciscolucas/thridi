...
<table>
    <thead>
        <tr style="border:solid 1px #000">
            ...
            <th style="border:solid 1px #000" class="thumb" width="600">Comentario</th>
            <th style="border:solid 1px #000" class="thumb" width="600">Imagem</th>
        </tr>
    </thead>
    <tbody>
         <?  foreach($adminminhas as $row){?>        
        <tr style="border:solid 1px #000">
            <td class="thumb" style="border:solid 1px #000"><?=$row->nome?></td>
            <td style="border:solid 1px #000"><?=$row->email?></td>
            <td style="border:solid 1px #000" class="titulo" width="600"><?=$row->comentario?></td>
            <td style="border:solid 1px #000" class="titulo" width="600"><img src="<? echo base_url() . 'uploads/minhathridi/' . $row->imagem; ?>"  /></td>
