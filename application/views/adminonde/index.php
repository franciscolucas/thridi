...
<p align="right"><a href="<?= base_url() ?>onde/" title="Ver quem somos" class="criarnovo" target="_blank">Visualizar Onde Encontrar</a></p>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="<?= base_url() ?>adminonde/editar/<?=$row->entry_id?>" class="acoes">Editar</a></td>
        </tr>
...
<form method="post" action="<?= base_url() ?>adminonde/cadastrarimagem/" id="inserir-blog" enctype="multipart/form-data">
