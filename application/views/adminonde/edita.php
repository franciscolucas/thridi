...
<h1>Onde Encontrar - Editar</h1>

<p align="right"><a href="<?= base_url() ?>adminonde" title="Voltar" class="criarnovo">Voltar</a></p>

<form method="post" action="<?= base_url() ?>adminonde/atualizar/" id="inserir-adminonde" enctype="multipart/form-data">
