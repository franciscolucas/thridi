...
<p align="right"><a href="<?= base_url() ?>closet/" title="Ver closet" class="criarnovo" target="_blank">Visualizar closet</a></p>
<p align="right"><a href="<?= base_url() ?>admincloset/cadastro" title="Cadastrar imagem" class="criarnovo">Cadastrar Imagem</a></p>
...
<table>
    ...
    <tbody>
        <?  foreach($adminclosets as $row){?>
            <?php 
              $config['image_library'] = 'gd2';
              $config['source_image'] = 'uploads/closet/'.$row->imagem;
              $config['new_image'] = 'uploads/closet/thumb/';
        ...
        <tr>
				...
				<? if ($ex == 'png'){?>
                    <td class="thumb"><img src="<?= base_url().'uploads/closet/thumb/'.$row->imagem.'_thumb.png'; ?>"  /></td>
				<? }?>
				...
				<? if ($ex == 'gif'){?>
                    <td class="thumb"><img src="<?= base_url().'uploads/closet/thumb/'.$row->imagem.'_thumb.gif'; ?>"  /></td>
				<? }?>
				...
				<? if ($ex == 'jpg'){?>
                    <td class="thumb"><img src="<?= base_url().'uploads/closet/thumb/'.$row->imagem.'_thumb.jpg'; ?>"  /></td>
				<? }?> 
            ...
            <td class="colecao"><a href="javascript:;" title="Deseja excluir item selecionado?" class="acoes" onclick="modal_confirma_excluir($(this),'admincloset','excluir_closet',<?=$row->id?>)">Excluir</a></td>
        </tr>
        <? }?>
