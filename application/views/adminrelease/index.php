...
<p align="right"><a href="<?= base_url() ?>release/" title="Ver quem somos" class="criarnovo" target="_blank">Visualizar Release</a></p>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="<?= base_url() ?>adminrelease/editar/<?=$row->entry_id?>" class="acoes">Editar</a></td>
        </tr>
...
<form method="post" action="<?= base_url() ?>adminrelease/cadastrarimagem/" id="inserir-blog" enctype="multipart/form-data">
