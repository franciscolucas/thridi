...
<h1>Release - Editar</h1>

<p align="right"><a href="<?= base_url() ?>adminrelease" title="Voltar" class="criarnovo">Voltar</a></p>

<form method="post" action="<?= base_url() ?>adminrelease/atualizar/" id="inserir-adminrelease" enctype="multipart/form-data">
